 ...
 // Declaramos alguna variables
  ...
  int puntuacion_maxima = 20;    // PuntuaciÃ³n mÃ¡xima donde acaba el juego 
 ...
 // Funcion para mostrar que botÃ³n se tenia que pulsar en caso de error del jugador
 ...
 // FunciÃ³n que reproduce la canciÃ³n al arrancar el arduino y para el juego cuando se llega a la puntuacion maxima
  void felicitacion() {
  digitalWrite(led_rojo, HIGH);       
  digitalWrite(led_verde, HIGH);
  digitalWrite(led_amarillo, HIGH);
 ...
 // Con esto hacemos que la funciÃ³n Random sea aun mas aleatoria
